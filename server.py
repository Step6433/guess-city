...
cities = {
    ...
    # Пример идентификаторов изображений Москвы
    'Нью-Йорк': ['1540737/8d702285aceb6a8d2c11', '1030494/c9b7244c325bbf45e763'],  # Пример идентификаторов Нью-Йорка
    'Париж': ['1030494/864cde96c659c976ab0d', '1540737/44a3b9adbd45a69ef158']  # Пример идентификаторов Парижа
}
